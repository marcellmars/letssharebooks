$(document).ready(function () {
    ...
    /* mock these in global scope. not exactly elegant... */

    gen_book_string_parts = function (base_url, format, book) {
        return {
            'base_url': '/get/',
            'format': '/',
            'book': book,
    ...
    gen_book_content = function (base_url, book, authors, formats) {
        return {
            'base_url': base_url,
            'book': book,
    ...
    gen_book_modal = function (base_url, book, formats) {
        return {
            'base_url': base_url,
            'book': book,
            'book_title_stripped': ' ' + book.title.replace(/\?/g, ''),
