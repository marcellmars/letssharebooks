...
# uncomment these lines + the two lines at the end to start and kill calibre-server from this script
#calibre-server --max-cover=300x400 --daemonize --pidfile=/tmp/calibre.pid -p 8080
